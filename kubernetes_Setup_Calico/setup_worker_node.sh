...
# Step 7: Join Kubernetes Worker Node to the Cluster
echo "Joining Kubernetes Worker Node to the Cluster..."
# Replace <join-command> with the actual `kubeadm join` command from the master node
# Example:
